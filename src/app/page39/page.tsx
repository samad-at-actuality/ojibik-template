        ...
        <div className="relative w-[8.5in] h-[11in] ">
          ...
          <div className="absolute left-[0.748in] top-[6.1106in] w-[3.4128in]">
            <div className="relative h-[2.75in] w-full">
              <Image
                src="/images/page39/export_1_20250819_130548.png"
          ...
          <div className="absolute left-[4.3362in] top-[6.1106in] w-[3.4in]">
            <div className="relative h-[2.7in] w-full">
              <Image
                src="/images/page39/export_1_20250819_130616.png"
            ...
            <Image
              ...
              height={1}
              sizes={`${6.6 * 96}px`}
              className="left-[7.2859in] top-[8.6513in] w-[0.4787in] h-[0.2.188in] absolute z-1"
              priority
            /> 
          ...
          {/* pill */}
          <div>
            <div className="absolute left-[6.3149in] top-[9.3582in]">
