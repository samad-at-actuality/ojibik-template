      ...
      <LetterPage backgroundColor="white">
        <div className="relative w-[8.5in] h-[11in] ">
          ...
          <div className="absolute left-[0.7535in] top-[1.2206in] w-[6.2161in] h-[4.1636in] z-0">
            <Image
              src="/images/page77/asset_p77_1_20250903_142709.png"
              alt="table"
              fill
          ...
          <div className="absolute left-[0.75in] top-[6.1106in] w-[5.2161in]">
            <div className="relative h-[4.1636in] w-full">
              <Image
                src="/images/page77/asset_p77_1_20250903_142714.png"
                alt="image"
                fill
                className="object-contain"
                sizes={`${3.45 * 96}px`}
            ...
            <Image
              ...
              height={1}
              sizes={`${6.6 * 96}px`}
              className="left-[5.2168in] top-[9.9896in] w-[0.4787in] h-[0.2188in] absolute z-1"
              priority
            />          
