      ...
      <LetterPage backgroundColor="white">
        <div className="relative w-[8.5in] h-[11in] ">
          ...
          <div className="absolute left-[0.748in] top-[1.2206in] w-[6.9883in] h-[7.42in] z-0">
            <Image
              src="/images/page98/asset_p98_1_20250912_141744.png"
              alt="table"
              fill
          ...
          <div className="absolute left-[0.7558in] top-[8.9351in] ">          
            <div className=" font-[LarkenDEMO-regular] text-[24pt] leading-[28pt] text-[#4b5846]">
              Sleep Nation North Mattress
              <div className="mt-2 mb-2 h-[2px] w-[7.001in] bg-[#4b5846]" />
            </div>

            <div className=" absolute  text-[9pt] leading-[11pt] text-[#333] font-[Diagramm-Regular]">
              <div className="text-[#333]">Mattress</div>
              <div className="font-[Diagramm-Bold]">M-2 </div>
              <div className="font-[Diagramm-Bold]">Sleep Nation North</div>
              <div>$763.55</div>
            </div>
          </div>
          ...
          <div className="absolute left-[4.3362in] top-[6.1106in] w-[3.4in]">
            ...
            <Image
              ...
              height={1}
              sizes={`${6.6 * 96}px`}
              className="left-[6.793in] top-[8.3627in] w-[0.8373in] h-[0.2479in] absolute z-1"
              priority
            /> 
