        ...
        <div className="relative w-[8.5in] h-[11in] ">
          ...
          <div className="absolute left-[0.75in] top-[0.675in]  text-[#4b5846]">
            <div className="flex items-baseline flex-nowrap">
              ...
              <span className="min-w-0 whitespace-normal font-[LarkenDEMO-Medium] text-[26.4pt] leading-[31.68pt]">
                608A
              </span>
            </div>
          </div>
          ...
          <div className="absolute left-[6.1274in] top-[1.2206in] w-[2.1in] text-[#4b5846]">
            ...
            <div className="mt-2 text-[#333] z-1">
              <div className="font-[Diagramm-Regular] text-[8.5pt] leading-[11pt]">
                ...
                <span className="text-[#333]">Dining Stool</span>
                <div className="mt- font-[Diagramm-Bold]">ST-1</div>
          ...
          <div className="absolute left-[0.748in] top-[1.2206in] w-[5.2161in] h-[4.1636in] z-0">
            <Image
              src="/images/page94/asset_p94_1_20250912_141631.png"
              alt="table"
              fill
          ...
          <div className="absolute left-[0.748in] top-[6.1106in] w-[3.4128in]">
            <div className="relative h-[2.75in] w-full">
              <Image
                src="/images/page94/asset_p94_1_20250912_141637.png"
                alt="Quorum"
                fill
                className="object-contain"
                sizes={`${3.45 * 96}px`}
              ...
              {/* top logo */}
            <Image
              src="/icons/allermuir.png"
              alt="Allermuir Logo"
              width={1}
              height={1}
              sizes={`${6.6 * 96}px`}
              className="left-[3.6848in] top-[8.6299in] w-[0.4283in] h-[0.0803in] absolute z-1"
              priority
            />          
          {/* Expansion table */}
          <div className="absolute left-[0.7558in] top-[8.9351in] ">          
            ...
            <div className=" absolute  text-[9pt] leading-[11pt] text-[#333] font-[Diagramm-Regular]">
              <div className="text-[#333]">Dining Stool</div>
              <div className="font-[Diagramm-Bold]">ST-1</div>
          ...
          <div className="absolute left-[4.3362in] top-[6.1106in] w-[3.4in]">
            <div className="relative h-[2.7in] w-full">
              <Image
                src="/images/page94/asset_p94_1_20250912_141650.png"
                alt="Expansion Casegoods"
                fill
                className="object-contain"
                sizes={`${3.45 * 96}px`}
              />
