      ...
      <LetterPage backgroundColor="white">
        <div className="relative w-[8.5in] h-[11in] ">
          ...
          <div className="absolute left-[6.124in] top-[1.221in] w-[2.1in] text-[#4b5846]">
            ...
            <div className="mt-2 text-[#333] z-1">
              <div className="font-[Diagramm-Regular] text-[8.5pt] leading-[11pt]">
                ...
                <span className="text-[#333]">Laptop Table</span>
                <div className="mt- font-[Diagramm-Bold]">T-5</div>
          ...
          <div className="absolute left-[0.7535in] top-[1.2206in] w-[5.2161in] h-[4.1636in] z-0">
            <Image
              src="/images/page78/asset_p78_1_20250903_142724.png"
              alt="table"
              fill
            ...
            <Image
              ...
              height={1}
              sizes={`${6.6 * 96}px`}
              className="left-[5.2663in] top-[5.0053in] w-[0.5787in] h-[0.1288in] absolute z-1"
              priority
            />
          ...
          <div className="absolute left-[0.75in] top-[6.1106in] w-[5.2161in]">
            <div className="relative h-[4.1636in] w-full">
              <Image
                src="/images/page78/asset_p78_1_20250903_142733.png"
                alt="image"
                fill
                className="object-contain"
                sizes={`${3.45 * 96}px`}
            ...
            <Image
              ...
              height={1}
              sizes={`${6.6 * 96}px`}
              className="left-[5.2168in] top-[9.9896in] w-[0.4779in] h-[0.2185in] absolute z-1"
              priority
            />          
          ...
          <div className="absolute left-[6.124in] top-[6.1042in] ">          
            ...
            <div className=" absolute  text-[9pt] leading-[11pt] text-[#333] font-[Diagramm-Regular]">
              <div className="text-[#333]">Laptop Table</div>
              <div className="font-[Diagramm-Bold]">T-5</div>
